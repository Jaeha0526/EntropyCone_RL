...
repo_root = os.path.dirname(os.path.dirname(script_dir))  # Go up two levels from analysis/n3/
base_dir = os.path.join(repo_root, 'results', 'n3_mmi_finding', 'gradient_quality', 'dS_analysis')
...
# Save
output_dir = os.path.join(repo_root, 'paper', 'plots')
os.makedirs(output_dir, exist_ok=True)
output_path = os.path.join(output_dir, 'samples_vs_alignment.png')
plt.savefig(output_path, dpi=150)
print(f"\nSaved: {output_path}")

output_pdf = os.path.join(output_dir, 'samples_vs_alignment.pdf')
