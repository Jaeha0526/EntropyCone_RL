...
base_dir = os.path.join(repo_root, 'results', 'n3_mmi_finding', 'gradient_quality', 'dS_analysis_2')
...
output_path = os.path.join(output_dir, 'dS_vs_gradient_quality_combined.png')
